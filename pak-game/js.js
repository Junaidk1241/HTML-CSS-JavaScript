...
function() {
  ...
  function(t, e, n) {
    ...
    function r() {
      var t, e, n = (r = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {}).name,
      r = r.value;
      s[n] = "CLS" === n ? r: Math.round(r),
      "timeToInteractive" === n && (s.hasOwnProperty("FID") ? i() : (t = 0, e = setInterval(function() { (s.hasOwnProperty("FID") || 10 < t) && (e && (clearInterval(e), e = null), i()),
        t += 1
      },
      500)))
    }
    ...
    e.calculateTTI = function() {
      ...
      } catch(t) { (0, a.error)('unable to calculate "web-vitals" performance metrics', t)
      }
    },
    e._collectVitals = r,
  ...
  function(t, e, n) {
    ...
    t.exports = function() {
      ...
      function D(t, e, n) {
        if (e.constructor === t.constructor && n === E && e.constructor.resolve === L) I(t, e);
      ...
      var et = function() {
        ...
        e.prototype.
          ...
          var n = this;
          var r = n.constructor;
          if (s(e)) return n.then(function(t) {
    ...
    function() {
      ...
      function v(n) {
        var t = new MutationObserver(function(t) {
          for (var e = (t = l(t)).next(); ! e.done; e = t.next())("childList" == (e = e.value).type &&
          function t(e, n) {
            for (var r = (e = l(e)).next(); ! r.done; r = e.next()) if (r = r.value, n.includes(r.nodeName.toLowerCase()) || t(r.children, n)) return 1
      ...
      function h(t, e) {
        ...
        for (var n = [], r = (e = l(e)).next(); ! r.done; r = e.next()) r = r.value,
        n.push({
          timestamp: r.start,
          type: "requestStart"
        }),
      ...
      function s(t) {
        ...
        (r = this).c = new PerformanceObserver(function(t) {
          for (var e, n = (t = l(t.getEntries())).next(); ! n.done; n = t.next())"resource" === (n = n.value).entryType && (r.b.push({
            start: n.fetchStart,
            end: n.responseEnd
          }), m(r, h(r.g, r.b) + 5e3)),
          "longtask" === n.entryType && (e = n.startTime + n.duration, r.a.push({
            start: n.startTime,
            end: e
          }), m(r, e + 5e3))
        }),
      ...
      function m(o, t) { ! o.i || o.v > t || (clearTimeout(o.j), o.j = setTimeout(function() {
          ...
          var i = o.a; (e = r - e < 5e3 ? null: r - (e = i.length ? i[i.length - 1].end: t) < 5e3 ? null: Math.max(e, n)) && (o.s(e), clearTimeout(o.j), o.i = !1, o.c && o.c.disconnect(), o.h && o.h.disconnect()),
      ...
      s.prototype.getFirstConsistentlyInteractive = function() {
        ...
        return new Promise(function(t) {
          e.s = t,
          "complete" == document.readyState ? c(e) : window.addEventListener("load",
          function() {
            c(e)
          })
        })
  ...
  function(t, e, n) {
    ...
    function o(t) {
      ...
      addEventListener("pointerup", o, T), addEventListener("pointercancel", u, T)) : a(e, t))
    }
    var v, h, u, m, y = -1,
    g = function(e, n) {
      function t(t) {
        "first-contentful-paint" === t.name && (a && a.disconnect(), t.startTime < i.firstHiddenTime && (o.value = t.startTime, o.entries.push(t), r(!0)))
      }
      var r, i = s(),
      o = c("FCP"),
      u = window.performance && performance.getEntriesByName && performance.getEntriesByName("first-contentful-paint")[0],
      a = u ? null: f("paint", t); (u || a) && (r = p(e, o, n), u && t(u), d(function(t) {
        o = c("FCP"),
        r = p(e, o, n),
    ...
    _ = function(e, t) {
      ...
      function n(t) { - 1 < b && e(t)
      }
      function r(t) {
        var e, n;
        t.hadRecentInput || (e = a[0], n = a[a.length - 1], u && t.startTime - n.startTime < 1e3 && t.startTime - e.startTime < 5e3 ? (u += t.value, a.push(t)) : (u = t.value, a = [t]), u > o.value && (o.value = u, o.entries = a, i()))
      }
      var i, o = c("CLS", 0),
      u = 0,
      a = [],
      s = f("layout-shift", r);
      s && (i = p(n, o, t), l(function() {
        s.takeRecords().map(r),
        i(!0)
      }), d(function() {
        b = -1,
    ...
    L = function(e) { ["mousedown", "keydown", "touchstart", "pointerdown"].forEach(function(t) {
        return e(t, o, T)
      })
    },
    x = function(t, e) {
      function n(t) {
        t.startTime < r.firstHiddenTime && (i.value = t.processingStart - t.startTime, i.entries.push(t), u(!0))
      }
      var r = s(),
      i = c("FID"),
      o = f("first-input", n),
    ...
    P = function(e) {
      ...
      t = function() {
        try {
          ...
          function() {
            ...
            for (t in e)"navigationStart" !== t && "toJSON" !== t && (n[t] = Math.max(e[t] - e.navigationStart, 0));
            return n
          } ();
      ...
      "complete" === document.readyState ? setTimeout(t, 0) : addEventListener("load",
      function() {
  ...
  function(t, e, n) {
    ...
    n = function() {
      ...
      e = Array(t), n = 0; n < t; n++) e[n] = arguments[n]; (0, r.getWindow)().console;
      return function() {}
    },
    n = (n(),
    function() {
  ...
  function(t, e, n) {
    ...
    t.exports = {
      ...
      removeUndefined: function t(e) {
        for (var n in e) void 0 === e[n] ? delete e[n] : "object" === i(e[n]) && (t(e[n]), 0 === Object.keys(e[n]).length && delete e[n])
      }
    }
  }],
  r = {},
